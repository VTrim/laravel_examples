...
Route::any('/telegram_auth', 'WebhookController@telegram_auth_webhook');
Route::any('/callback/xE4sA/', 'WebhookController@vkbot_webhook');

Route::get('/mail/{id?}', 'MailController@index')->where(['id' => '[0-9]+']);
Route::get('/mail/open/{id?}', 'MailController@open')->where(['id' => '[0-9]+']);
Route::post('/mail/send', 'MailController@send');
Route::get('/mail/server/{timestamp?}', 'MailController@server')->where(['timestamp' => '[0-9]+']);


Route::get('/telegram-auth-{string_auth?}', 'WebhookController@telegram_auth');
